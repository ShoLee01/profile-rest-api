...
PROJECT_GIT_URL='https://github.com/ShoLee01/profile-rest-api.git'
...
cp $PROJECT_BASE_PATH/profile-rest-api/deploy/supervisor_profiles_api.conf /etc/supervisor/conf.d/profile_api.conf
supervisorctl reread
supervisorctl update
supervisorctl restart profile_api

# Setup nginx to make our application accessible.
cp $PROJECT_BASE_PATH/profile-rest-api/deploy/nginx_profiles_api.conf /etc/nginx/sites-available/profile_api.conf
